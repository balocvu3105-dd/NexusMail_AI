...
{
    /// <inheritdoc />
    public partial class Sprint3_EmailAccount : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EncryptionVersion = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmailAccounts_WorkspaceId_EmailAddress",
                table: "EmailAccounts",
